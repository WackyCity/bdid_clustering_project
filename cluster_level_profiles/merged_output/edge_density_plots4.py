...
# Setup
input_dir = "."  # 🔁 Replace this with the actual path
                ...
                if key in fname and fname.endswith(".csv"):
                    ...
                    try:
                        ...
                        if not edge_density.empty:
                            ...
                            # Alpha and z-order logic
                            alpha = 0.3 if key == background_key else (0.4 if key == brown_key else 0.6)
                            zorder = 0 if key == background_key else (1 if key == brown_key else 2)
...
print(f"\n✅ Scatter plots with custom styling saved to:\n{pdf_path}")
